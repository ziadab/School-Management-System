							...
							var btns='<div class="btn-group dropleft"> \
								  ...
								  <div class="dropdown-menu shadow p-3 mb-5 bg-white rounded" id="dropdownCycle"> \
							        ...
							        <div class="dropdown-divider"></div> \
								  	...
								  	<div class="dropdown-divider"></div> \
								  	<a class="dropdown-item classe-full-details text-primary" href="${pageContext.request.contextPath}/E.Professeur/Controle?id='+response[i].id+'" classeId="'+response[i].id+'"><span class="fa fa-cog mr-4"></span>Détails</a> \
								  </div> \
								</div> ';
