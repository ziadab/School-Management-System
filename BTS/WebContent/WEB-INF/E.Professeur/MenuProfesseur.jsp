		<ul class="list-unstyled components mb-5">
	          <li class="active">
	            <a href="#"><span class="fa fa-home"></span>Accueil</a>
	             ...
	             <li>
	            <a href="${pageContext.request.contextPath}/E.Professeur/Chapitre"><span class="far fa-file-alt"></span>Chapitre</a>
	          </li>
	           <li> 
	              <a href="${pageContext.request.contextPath}/E.Professeur/Classes"><span class="fa fa-chalkboard-teacher"></span>Classes</a>
	          </li>
			  <li> 
	              <a href="#"><span class="far fa-calendar-alt"></span>Emplois</a>
	          </li>
	          <li>
	            <a href="${pageContext.request.contextPath}/E.Professeur/Evaluation"><span class="fa fa-file-signature"></span>Evaluations</a>
	          </li>
			  <li>
