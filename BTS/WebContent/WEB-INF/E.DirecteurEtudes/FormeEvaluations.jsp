...
<html>
  <head>
  	<title>Liste des formes d'évaluation</title>
	...
	<div class="container"> 
		...
		<div class="col-md-9"> <!-- Col 1 -->
				<div class="alert bg-light text-secondary" role="alert">
		   			...
		   			Formes d'évaluation
			        <a href="#" data-toggle="modal" data-target="#formeExamen_Add_Modal" class="btn btn-outline-info float-right" title="Ajouter un formes d'examen"><i class="fa fa-plus"></i></a>
				...
				<!-- Début : Modal Add New FormeEvaluation -->
					<div id="formeExamen_Add_Modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
				 ...
				 <!-- Début : Modal Update FormeEvaluation -->
					<div id="formeExamen_Update_Modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" data-backdrop="false">
						<div class="modal-dialog">
				...
				<!-- Début : Modal Details FormeEvaluation -->
					<div id="formeExamen_Details_Modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true" data-backdrop="false">
						<div class="modal-dialog">
					      	<div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
					          	<div class="modal-header bg-info">
					        		<h4 class="modal-title text-white">
					          	...
					          	<div class="modal-body">
					          		<ul class="list-group">
										<!-- Affichage dynamique des détails de la formeExamen-->
									</ul>
								</div>
								<div class="modal-footer ">
...
<!-- Fin : Moad Loading Ajax -->
	...
	<script src="${pageContext.request.contextPath}/js/buttons.print.min.js" type="text/javascript"></script>
  	...
  	$(document).ready(function() {
		...
		//Chargement des Filières dans le DataTable Filières
 			populateFormeEvaluationDataTable();
 			/********** Ajouter une nouvelle FormeEvaluation **********************/
			...
			return false;
 			...
 			/* 1 - Récuperer l' Id de la FormeEvaluation séléctionner sur la DataTable FormeEvaluations
			...
			return false;
 			...
 			/* 2 - Supprimer via ajax le FormeEvaluation concerné
 			*****************************************************/
			...
			return false;
 			...
 			/* 1 - Récuperer l' Id de la formes d'examen séléctionner sur la DataTable Filiers
 			/* 2 - Charger par ajax la formes d'examen concernée
 			/* 3 - Afficher les détails la formes d'examen concernée
 			*****************************************************/
			...
			$.ajax({
				...
				success: function(response,textStatus ,jqXHR){
					...
					var nom_FrItem ='<li class="list-group-item"><span><strong>Nom de la forme d\'évaluation  </strong></span><span class="float-right">'+response.nom_Fr+'</span></li>';
					var nom_ArItem ='<li class="list-group-item"><span class="float-right"><strong>إسم شكل الإختبار</strong></span><span class="float-left" dir="rtl">'+response.nom_Ar+'</span></li>';
