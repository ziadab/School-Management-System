		...
		<div class="col-md-9"> <!-- Col 1 -->
			<div class="alert bg-light text-secondary" role="alert">
		     ...
		     <div class="panel-heading">
					<nav class="nav nav-tabs flex-column flex-sm-row"  id="Tab-Content" role="tablist">
					    <a id="tab_controles" href="#content-tab-controles" class="nav-item nav-link active" data-toggle="tab" role="tab" aria-controls="content-tab-controles" aria-selected="false">
					        <i class="fa fa-users mr-2"></i> Controles
					    </a>
					    <a id="tab_examens" href="#content-tab-examens" class="nav-item nav-link" data-toggle="tab" role="tab" aria-controls="content-tab-examens" aria-selected="false">
					        <i class="fa fa-calendar-alt mr-2"></i> Examens
					    </a>
					    <a id="tab-soutenance" href="#content-tab-soutenance" class="nav-item nav-link" data-toggle="tab" role="tab" aria-controls="content-tab-soutenance" aria-selected="false">
					        <i class="fa fa-user-check mr-2"></i> Soutenance
					    </a>
					</nav>
			</div>
			<div class="panel-body">
				<div class="tab-content" id="Tab-Content">
					...
					<div id="content-tab-controles" class="tab-pane active" role="tabpanel" aria-labelledby="">
					...
					<div id="content-tab-examens" class="tab-pane active" role="tabpanel" aria-labelledby="">
					</div>
					<div id="content-tab-soutenance" class="tab-pane active" role="tabpanel" aria-labelledby="">
					</div>
				</div>
			</div>
		</div>
				...
				$.ajax({
					...
					success: function(response,textStatus ,jqXHR){
						...
						for(i=0;i<response.length;i++){
							var rang=i+1;
								var controle = response[i].controle.module.nom_Ar;
