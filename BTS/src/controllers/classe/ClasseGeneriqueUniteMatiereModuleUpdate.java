 ...
 */
@WebServlet("/ClasseGenerique/Unite/Matiere/Module/Update")
public class ClasseGeneriqueUniteMatiereModuleUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ConfigurationModuleDAO configurationModuleDAO;
       
    public ClasseGeneriqueUniteMatiereModuleUpdate() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			//TODO : ce test est incomplet : à corriger pour 
			// éviter la duplication d'un module dans d'autre unités ou d'autres matières
//			if(configurationModuleDAO.exists(configurationModule)== null){
				configurationModuleDAO.update(configurationModule);
				success=true;
				warning = false;
				message="Le module a élé modifié avec succès";
				
//			}else{
//				success=true;
//				warning = true;
//				message="Ce module existe déja dans l'une des matières ";
//			}
