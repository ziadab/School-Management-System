...
public class Etudiant extends Utilisateur {
	...
	public Etudiant() {
		super();
		//Initialiser à Null la Scolarité et les Absences lors de la Création d'un étudiant
	...
	public Etudiant(int id, String nom_Fr, String nom_Ar, String prenom_Fr,
		...
		// Initialiser les attribut propres à l'étudiant
		this.cne=cne;
		...
		//Initialiser à Null la Scolarité et ces Absences lors de la Création
		this.scolarites = new ArrayList<Scolarite>();
		this.absencesEtudiant = new ArrayList<AbsenceEtudiant>();
