...
public class DemandePhotocopie {
	...
	//Attribut dérivé non perssistant servant à calculer le nombre de copie 
	//en fonction des nombre d'étudiants des classe concérnée
	...
	public DemandePhotocopie(int id, Professeur professeur, Date date,
		...
		//TODO : calculer le nombre de copie en fonction des nombre d'étudiants des classes concernées
		this.nbreCopie = 0;
	}
