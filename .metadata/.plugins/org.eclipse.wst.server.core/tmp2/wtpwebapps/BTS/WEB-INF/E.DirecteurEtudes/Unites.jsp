				      	...
				      	<div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
				          	...
				          	<div class="modal-body">
				          		<div class="form-group row">
						    		<label for="unite_code" class="col-sm-3 control-label">Code</label>
								    <div class="col-sm-9">
								      <input id="unite_code" type="text" class="form-control" name="code" placeholder="Code de l'unité" required/>
								    </div>
						  		</div>
								<div class="form-group row">
								  <label for="unite_Nom_Fr" class="col-sm-3 control-label">Nom de l'unité</label>
								  <div class="col-sm-9">
								    <input id="unite_Nom_Fr" type="text" class="form-control" name="nom_Fr" placeholder="Nom de l'unité" required/>
								  </div>
								</div>
						  		<div class="form-group row">
								  <label for="unite_Nom_Ar" class="col-sm-3 control-label">إسم الوحدة</label>
								  <div class="col-sm-9">
								    <input id="unite_Nom_Ar" type="text" class="form-control" name="nom_Ar" dir="rtl" placeholder="إسم الوحدة بالعربية"/>
								  </div>
								</div>
				      	</div>
  	...
  	$(document).ready(function() {
		...
		/*******************Fin : Ajax Load Animation *************************/
  		...
  		/************** DataTable du Tab : Unites **************/
			...
			//Chargement des Unités dans le DataTbale Unites
			populateUniteDataTable();
  			...
  			*****************************************************/
  			...
  			/*********** Affichage des détails d'un Unite ****************
  			/* 1 - Récuperer l' Id du Unite séléctionner sur la DataTable Unites
  			/* 2 - Charger par ajax le Unite concerné
